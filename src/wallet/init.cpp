...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-spendzeroconftx", strprintf("Spend unconfirmed outputs when sending transactions (default: %u)", DEFAULT_SPEND_ZEROCONF_TX), false, OptionsCategory::WALLET);
